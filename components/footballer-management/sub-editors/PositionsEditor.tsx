          ...
          : (
              <>
                ...
                <div className="flex items-center gap-2">
                  <Select value={pickerValue} onValueChange={setPickerValue}>
                    ...
                    <SelectContent>
                      {available.length === 0
                        ? (
                            <div className="px-3 py-2 text-sm text-muted-foreground">All positions assigned.</div>
                          )
                        : available.map(p => (
                ...
                {draft.length === 0
                  ...
                  : (
                      <ul className="divide-y rounded-md border dark:divide-slate-700">
                        {draft.map((d, idx) => (
                          <li key={d.position_id} className="flex items-center gap-2 px-3 py-2">
                            ...
                            <Button
                              ...
                              className={cn('size-8', d.is_primary ? 'text-emerald-600' : 'text-muted-foreground/70 hover:text-emerald-600')}
                            >
