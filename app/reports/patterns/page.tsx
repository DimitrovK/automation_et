...
export default function PatternsPage() {
  ...
  const peakHourCount = state.data?.by_hour.find(row => row.hour === state.data?.peak_hour)?.games_started ?? 0;
  const quietestDay = state.data ? [...state.data.by_weekday].sort((a, b) => a.games_started - b.games_started)[0] : null;
    ...
    >
      ...
      <div className="flex justify-end">
        <ExportButton
          ...
          rows={state.data?.by_hour_weekday ?? []}
          view="patterns"
