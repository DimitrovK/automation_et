...
export const DIFFICULTY_TIERS: Record<string, DataTier> = {
  EASY: {
    ...
    chip: 'from-slate-200 via-emerald-200 to-green-100 text-green-900 ring-1 ring-inset ring-green-400/40 dark:from-slate-900 dark:via-emerald-800 dark:to-green-600 dark:text-white dark:ring-green-500/30',
    chipAlt: 'from-green-100 via-emerald-200 to-slate-200 text-green-900 ring-1 ring-inset ring-green-400/40 dark:from-green-600 dark:via-emerald-800 dark:to-slate-900 dark:text-white dark:ring-green-500/30',
  ...
  NORMAL: {
    ...
    chip: 'from-slate-200 via-sky-200 to-blue-100 text-blue-900 ring-1 ring-inset ring-blue-400/40 dark:from-slate-900 dark:via-sky-800 dark:to-blue-600 dark:text-white dark:ring-blue-500/30',
    chipAlt: 'from-blue-100 via-sky-200 to-slate-200 text-blue-900 ring-1 ring-inset ring-blue-400/40 dark:from-blue-600 dark:via-sky-800 dark:to-slate-900 dark:text-white dark:ring-blue-500/30',
  ...
  HARD: {
    ...
    chip: 'from-slate-200 via-amber-200 to-orange-100 text-orange-900 ring-1 ring-inset ring-orange-400/40 dark:from-slate-900 dark:via-amber-800 dark:to-orange-600 dark:text-white dark:ring-orange-500/30',
    chipAlt: 'from-orange-100 via-amber-200 to-slate-200 text-orange-900 ring-1 ring-inset ring-orange-400/40 dark:from-orange-600 dark:via-amber-800 dark:to-slate-900 dark:text-white dark:ring-orange-500/30',
  ...
  EXTREME: {
    ...
    track: 'bg-red-400/20',
    chip: 'from-slate-200 via-rose-200 to-red-100 text-red-900 ring-1 ring-inset ring-red-400/40 dark:from-slate-900 dark:via-rose-800 dark:to-red-600 dark:text-white dark:ring-red-500/30',
    chipAlt: 'from-red-100 via-rose-200 to-slate-200 text-red-900 ring-1 ring-inset ring-red-400/40 dark:from-red-600 dark:via-rose-800 dark:to-slate-900 dark:text-white dark:ring-red-500/30',
